...
override_git_prompt_colors() {
  ...
  GIT_PROMPT_CONFLICTS="${Red}C"       # the number of files in conflict
  GIT_PROMPT_CHANGED="${Green}M"        # the number of changed files

  GIT_PROMPT_REMOTE=" "                 # the remote branch name (if any) and the symbols for ahead and behind
  GIT_PROMPT_UNTRACKED="${Yellow}U"       # the number of untracked files/dirs
  ...
  GIT_PROMPT_SYMBOLS_AHEAD="${BoldMagenta}↑${ResetColor}·"             # The symbol for "n versions ahead of origin"
  GIT_PROMPT_SYMBOLS_BEHIND="${BoldCyan}↓${ResetColor}·"            # The symbol for "n versions behind of origin"
